...
public class LoginFrame extends JFrame {
	...
	public LoginFrame() {
		...
		imgHotel.setIcon(new ImageIcon(LoginFrame.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
		        ...
		        if( usuario.checkLogin(login, senha) || (login.equals("admin")) && senha.equals("admin")) {
		            MenuUsuario menu = new MenuUsuario();
		            menu.setVisible(true);
		            dispose();	 
		        }else {
		            JOptionPane.showMessageDialog(panel, "Usuario ou Senha não válidos");
		        }
			}
		});
		btnLogin.setBackground(SystemColor.textHighlight);
		...
		logo.setIcon(new ImageIcon(LoginFrame.class.getResource("/imagenes/lOGO-50PX.png")));

	...
	public MenuUsuario() {
		...
		btnBuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				BuscarFrame buscar = new BuscarFrame();
		...
		JPanel btnAdministracao = new JPanel();
		btnAdministracao.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAdministracao.setBackground(new Color(118, 187, 223));
			}

			@Override
			public void mouseExited(MouseEvent e) {
				btnAdministracao.setBackground(new Color(12, 138, 199));
			}
		...
		btnAdministracao.setBounds(0, 370, 257, 66);
		btnAdministracao.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnAdministracao);
		btnAdministracao.setLayout(null);
		btnAdministracao.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		JLabel labelAdministracao = new JLabel("<html>Administração </br> do Sistema </html>");
		labelAdministracao.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/reservado.png")));
		labelAdministracao.setForeground(SystemColor.text);
		labelAdministracao.setBounds(20, 5, 210, 55);
		labelAdministracao.setFont(new Font("Roboto", Font.PLAIN, 18));
		labelAdministracao.setHorizontalAlignment(SwingConstants.LEFT);
		btnAdministracao.add(labelAdministracao);
		...
		labelFecha.setBounds(215, 63, 294, 36);
